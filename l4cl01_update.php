	...
	<form class="form-horizontal" enctype="multipart/form-data" method="post" id="myform" name="myform" action="" target="hidden_frame">
		...
		<table border="1" style="width:100%;">
			...
			<tr>
				...
				<td '.$cs7.'> 
					<input type="hidden" name="risk_id" id="risk_idID" />
					<input type="hidden" name="cp_id" id="cp_idID" /> 
					<input name="rmAppId" '.$cs4.' '.$cs5.' id="rmAppIdID" '.$ro.'  />
				</td>
				<td '.$cs1.'>
					&nbsp车主名称
				</td>
				<td colspan="5" style="width:65%;">
					<input name="rmAppPerName" '.$cs4.' '.$cs5.' id="rmAppPerNameID" '.$ro.' />
				</td>
			</tr>
			<tr>
				<th colspan="8" '.$cs3.'>
			...
			<tr>
				...
				<td colspan="6" '.$cs2.'>
					...
					<textarea class="form-control" '.$cs4.' rows="3" id="rm2scYanCheGaiShuID" name="rm2scYanCheGaiShu">
					</textarea>
				</td>
			</tr>
			<tr style="display:none;">
				...
				<td colspan="6" '.$cs2.'>
					...
					<textarea class="form-control" '.$cs4.' rows="3" id="rm2scQiTaGaiShuID" name="rm2scQiTaGaiShu">
					</textarea>
				</td>
			</tr>
			<tr>
