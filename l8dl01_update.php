...
<body>
	...
	<form class="form-horizontal" enctype="multipart/form-data" method="post" id="myform" name="myform" action="" target="hidden_frame"> 
		<table border="1" style="width:100%;">
			...
			<tr>
				<td style="width:10%;">
					&nbsp登录名<!--- <font color="red">不可改</font>  -->
				</td>
				<td style="width:15%;">
					<input name="login_name" readonly="readonly" style="display:inline; width:100%;" class="form-control" type="text" id="login_nameID" /> 
				</td>
				<td style="width:10%;">
					&nbsp密码
				</td>
				<td style="width:15%;">
					<input name="password" style="display:inline; width:100%;" class="form-control" type="text" id="passwordID" />
				</td>
				<td style="width:10%;">
					&nbsp真实姓名
				</td>
				<td style="width:15%;">
					<input name="real_name" style="display:inline; width:100%;" class="form-control" type="text" id="real_nameID" />
				</td>
				<td style="width:10%;">
					&nbsp事务等级
				</td>
				<td style="width:15%;">
					<div class="btn-group select" id="job_gradeID" onchange="showTeam();">
					</div>
					<input type="hidden" onchange="showTeam();" id="job_gradeID_" name="job_grade" />
				</td>
			</tr> 
			<tr id="select_team" style="display:;">
			...
			<tr>
				<th colspan="8" style="text-align:left;height:23px;background-color: #E0E0E0">
					<font color="red">注：本更新功能最好只用于更改密码和真名。</font>若需要增加成员，请用“添加”或“删除”成员功能。
				</th>
			</tr>
		</table>
